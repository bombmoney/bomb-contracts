...
export interface TShareRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface TShareRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TShareRewardPoolInterface;
