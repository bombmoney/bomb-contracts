...
export interface TombInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "INITIAL_TOMB_POOL_DISTRIBUTION",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Tomb extends BaseContract {
  ...
  INITIAL_TOMB_POOL_DISTRIBUTION(overrides?: CallOverrides): Promise<BigNumber>;
