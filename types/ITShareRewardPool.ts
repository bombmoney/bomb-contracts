...
export interface IBShareRewardPoolInterface extends utils.Interface {
    functions: {
...
export interface IBShareRewardPool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;

    interface: IBShareRewardPoolInterface;
    ...
    functions: {
        ...
        userInfo(_pid: BigNumberish, _user: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {amount: BigNumber; rewardDebt: BigNumber}>;
    ...
    estimateGas: {
        ...
        userInfo(_pid: BigNumberish, _user: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        userInfo(_pid: BigNumberish, _user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
