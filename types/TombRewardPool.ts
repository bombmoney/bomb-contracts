...
export interface BombRewardPoolInterface extends utils.Interface {
    functions: {
        'add(uint256,address,bool,uint256)': FunctionFragment;
        'deposit(uint256,uint256)': FunctionFragment;
        'emergencyWithdraw(uint256)': FunctionFragment;
        'epochEndTimes(uint256)': FunctionFragment;
        'epochBombPerSecond(uint256)': FunctionFragment;
    ...
    encodeFunctionData(functionFragment: 'epochEndTimes', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'epochBombPerSecond', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'epochTotalRewards', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'getGeneratedReward', values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'pendingBOMB', values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: 'poolInfo', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'poolStartTime', values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: 'epochEndTimes', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'epochBombPerSecond', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'epochTotalRewards', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'getGeneratedReward', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'pendingBOMB', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'poolInfo', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'poolStartTime', data: BytesLike): Result;
...
export type DepositEvent = TypedEvent<[string, BigNumber, BigNumber], {user: string; pid: BigNumber; amount: BigNumber}>;

export type DepositEventFilter = TypedEventFilter<DepositEvent>;

export type EmergencyWithdrawEvent = TypedEvent<[string, BigNumber, BigNumber], {user: string; pid: BigNumber; amount: BigNumber}>;

export type EmergencyWithdrawEventFilter = TypedEventFilter<EmergencyWithdrawEvent>;

export type RewardPaidEvent = TypedEvent<[string, BigNumber], {user: string; amount: BigNumber}>;

export type RewardPaidEventFilter = TypedEventFilter<RewardPaidEvent>;

export type WithdrawEvent = TypedEvent<[string, BigNumber, BigNumber], {user: string; pid: BigNumber; amount: BigNumber}>;

export type WithdrawEventFilter = TypedEventFilter<WithdrawEvent>;

export interface BombRewardPool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;

    interface: BombRewardPoolInterface;
    ...
    functions: {
        ...
        epochEndTimes(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;

        epochBombPerSecond(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;

        epochTotalRewards(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;

        getGeneratedReward(_fromTime: BigNumberish, _toTime: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        pendingBOMB(_pid: BigNumberish, _user: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        set(_pid: BigNumberish, _allocPoint: BigNumberish, overrides?: Overrides & {from?: string | Promise<string>}): Promise<ContractTransaction>;
    ...
    callStatic: {
        add(_allocPoint: BigNumberish, _token: string, _withUpdate: boolean, _lastRewardTime: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        governanceRecoverUnsupported(_token: string, amount: BigNumberish, to: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        'RewardPaid(address,uint256)'(user?: string | null, amount?: null): RewardPaidEventFilter;
    ...
    estimateGas: {
        ...
        set(_pid: BigNumberish, _allocPoint: BigNumberish, overrides?: Overrides & {from?: string | Promise<string>}): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        epochEndTimes(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        epochBombPerSecond(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        epochTotalRewards(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

        getGeneratedReward(_fromTime: BigNumberish, _toTime: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        pendingBOMB(_pid: BigNumberish, _user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        set(_pid: BigNumberish, _allocPoint: BigNumberish, overrides?: Overrides & {from?: string | Promise<string>}): Promise<PopulatedTransaction>;
