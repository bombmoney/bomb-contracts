...
export interface TombRewardPoolInterface extends utils.Interface {
  functions: {
    "add(uint256,address,bool,uint256)": FunctionFragment;
    "deposit(uint256,uint256)": FunctionFragment;
    "emergencyWithdraw(uint256)": FunctionFragment;
    "epochEndTimes(uint256)": FunctionFragment;
    "epochTombPerSecond(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "epochTombPerSecond",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface TombRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TombRewardPoolInterface;
