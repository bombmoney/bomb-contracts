...
export interface MasonryInterface extends utils.Interface {
  functions: {
    ...
    "masonryHistory(uint256)": FunctionFragment;
    "masons(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "masonryHistory",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "masons", values: [string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "masons", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "nextEpochPoint",
    data: BytesLike
  ): Result;
...
export interface Masonry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MasonryInterface;
  ...
  functions: {
    ...
    canWithdraw(mason: string, overrides?: CallOverrides): Promise<[boolean]>;

    claimReward(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    earned(mason: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  canClaimReward(mason: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    canWithdraw(mason: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    masons(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
